...
namespace Unity.PlasticSCM.Editor
{
            ...
            MergeInProgress.IShowMergeView
    {
        ...
        internal SelectedTab SelectedView
        {
        ...
        {
            mWorkspaceOperationsMonitor.RegisterPendingChangesView(PendingChangesTab);
            mWorkspaceOperationsMonitor.RegisterIncomingChangesView(IncomingChangesTab);
        ...
        internal void ShowPendingChangesView()
        {
            ...
            bool wasPendingChangesSelected = IsViewSelected(SelectedTab.PendingChanges);
        ...
        internal void ShowChangesetsView()
        {
            ...
            bool wasChangesetsSelected = IsViewSelected(SelectedTab.Changesets);
        ...
        internal void ShowBranchesView()
        {
            ...
            bool wasBranchesSelected = IsViewSelected(SelectedTab.Branches);
        ...
        internal void ShowLocksView()
        {
            ...
            bool wasLocksViewSelected = IsViewSelected(SelectedTab.Locks);
        ...
        )
        {
            ...
            HistoryTab.RefreshForItem(itemId, path, isDirectory);
        ...
        void OpenLocksTab()
        {
            if (LocksTab == null)
            {
                ...
                TrackFeatureUseEvent.For(mRepSpec, TrackFeatureUseEvent.Features.OpenLocksView);
            }
        ...
        void ShowIncomingChangesView()
        {
            ...
            bool wasIncomingChangesSelected = IsViewSelected(SelectedTab.IncomingChanges);
        ...
        void ShowMergeView()
        {
            ...
            bool wasMergeTabSelected = IsViewSelected(SelectedTab.Merge);
        ...
        void CloseBranchesTab()
        {
            ...
            mViewHost.RemoveRefreshableView(ViewType.BranchesView, BranchesTab);
        ...
        void CloseLocksTab()
        {
            ...
            TrackFeatureUseEvent.For(mRepSpec, TrackFeatureUseEvent.Features.CloseLocksView);
        ...
        {
            mViewHost.RemoveRefreshableView(ViewType.HistoryView, HistoryTab);
        ...
        void PendingChangesTabButtonGUI()
        {
            ...
            bool isPendingChangesSelected = mPendingChangesTabButton.DrawTabButton(
                PlasticLocalization.GetString(PlasticLocalization.Name.PendingChangesViewTitle),
        ...
        void IncomingChangesTabButtonGUI()
        {
            ...
            bool isIncomingChangesSelected = mIncomingChangesTabButton.DrawTabButton(
                PlasticLocalization.GetString(PlasticLocalization.Name.IncomingChangesViewTitle),
        ...
        void ChangesetsTabButtonGUI()
        {
            ...
            bool isChangesetsSelected = mChangesetsTabButton.DrawTabButton(
                PlasticLocalization.GetString(PlasticLocalization.Name.ChangesetsViewTitle),
        ...
        void BranchesTabButtonGUI()
        {
            ...
            bool isBranchesSelected = mBranchesTabButton.DrawClosableTabButton(
                PlasticLocalization.GetString(PlasticLocalization.Name.BranchesViewTitle),
                wasBranchesSelected,
                true,
                mTabButtonWidth,
        ...
        void MergeTabButtonGUI()
        {
            ...
            bool wasMergeSelected = IsViewSelected(SelectedTab.Merge);

            bool isCloseButtonClicked;

            bool isMergeSelected = mMergeTabButton.DrawClosableTabButton(
        ...
        void HistoryTabButtonGUI()
        {
            ...
            bool wasHistorySelected = IsViewSelected(SelectedTab.History);

            bool isCloseButtonClicked;

            bool isHistorySelected = mHistoryTabButton.DrawClosableTabButton(
                PlasticLocalization.GetString(PlasticLocalization.Name.FileHistory),
                wasHistorySelected,
                true,
                mTabButtonWidth,
